...
test('filterMoviesCollection works properly with genre', () => {
  expect(filterMoviesCollection(start, { queryString: 'action', selectedFilter: 'genre' })).toEqual(result1);
});

test('filterMoviesCollection works properly with title', () => {
    expect(filterMoviesCollection(start, { queryString: 'Zootopia', selectedFilter: 'title' })).toEqual(result2);
});